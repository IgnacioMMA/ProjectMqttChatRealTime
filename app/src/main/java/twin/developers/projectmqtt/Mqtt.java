...
public class Mqtt {
    ...
    private static final String TOPIC = "iot/lab/test/nacho";
    private static final int QOS = 2;

    private MqttAndroidClient mqttClient;

    public Mqtt(Context context, MqttMessageListener listener) {
        ...
        mqttClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                if (listener != null) {
                    listener.onMessageReceived(new String(message.getPayload()));
                }
            }
